  ...
  protected:
    virtual void DefineRules()
    {
        ...
        AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Type",
                                                          ...
                                                          "Type of run: Isothermal |  Non-Isothermal",
                                                          true));

        AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@ConstantVolume",
                                                          OpenSMOKE::SINGLE_BOOL,
                                                          "Wethere to run a simualtion at constant volume or constant porosity",
                                                          true));
        ...
        AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@InitialRadius",
                                                          OpenSMOKE::SINGLE_MEASURE,
                                                          "Initial sphere radius (es. 0.1m)",
                                                          true));
